...
class SyntaxVariationTest(object):
    ...
    def change_syntax(self, x, meta=False, *args, **kwargs):
        ...
        syntax_variation_mapping = {
            "the cat chased the dog.": "it was the cat that chased the dog.",
            "What the cat chased was the dog.": "the cat chased the dog.",
            "It was the cat that chased the dog.": "What the cat chased was the dog.",
            "Pia gives the lecture.": "the lecture is given by Pia.",
            "Piek likes robots.": "Does Piek like robots?",
        }
    ...
    def construct_template(self):
        ...
        data = [
            ...
            "What the cat chased was the dog.",
            "It was the cat that chased the dog.",
            "Pia gives the lecture.",
            "Piek likes robots."
        ]
